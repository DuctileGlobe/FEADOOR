                    ...
                    <div class="review-header">
                        <div class="company-info">
                            <img src="https://logo.clearbit.com/${review.company_domain || ''}" 
                                 alt="${review.company_name || 'Empresa'}" 
                                 class="company-logo"
                                 onerror="this.src='https://ui-avatars.com/api/?name=${encodeURIComponent(review.company_name || 'Empresa')}&background=1a237e&color=fff'">
                            <div>
                                <h3>${review.position || 'Cargo não especificado'}</h3>
                                <h4>${review.company_name || 'Empresa não especificada'}</h4>
                                <span class="review-date">Avaliado em ${formatDate(review.createdAt || new Date())}</span>
                            </div>
                        </div>
                    ...
                    <div class="review-content">
                        <div class="review-stats">
                            <div class="stat-item">
                                ...
                                <span>${formatSalary(review.salary || 0)}</span>
                            </div>
                            <div class="stat-item">
                                <i class="fas fa-graduation-cap"></i>
                                <span>Conciliação: ${review.reconciliation_difficulty || 'N/A'}</span>
                            </div>
                            <div class="stat-item">
                                <i class="fas fa-user-graduate"></i>
                                <span>Processo: ${review.process_difficulty || 'N/A'}</span>
                            </div>
                        </div>
                        
                        <div class="review-text">
                            <h5>Benefícios</h5>
                            <p>${review.benefits || 'Não especificados'}</p>
